...
using LogoUI.Samples.Client.Tests.Gui.Fake;
using LogoUI.Samples.Client.Tests.Gui.Shared.Integration;

namespace LogoUI.Samples.Client.Gui.Tests.Compliance.Integration
{
    [TestFixture]
    ...
    {        
        ...
        public void ServerReturnsComplianceRecords_ComplianceScreenIsAccessed_ComplianceRecordsAreDisplayed()
        {
            ...
            var complianceRecords =
                moduleRootViewModel.ActiveItem.ListViewModel.Items.OfType<ComplianceRecordViewModel>();
